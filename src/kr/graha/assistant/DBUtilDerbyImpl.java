...
public class DBUtilDerbyImpl extends DBUtil {
	...
	public DBUtilDerbyImpl() throws IOException {
...
//			sql += "TABLE_TYPE varchar(50),\n";
	...
	public Hashtable<String, String> getComments(Connection con, String schemaName, String tableName, boolean table) {
		...
		try {
			if(table) {
				sql = "select SCHEMA_NAME, TABLE_NAME, COMMENTS from GRAHA_TAB_COMMENTS";
			} else {
				sql = "select SCHEMA_NAME, TABLE_NAME, COLUMN_NAME, COMMENTS from GRAHA_COL_COMMENTS";
			}
			if(tableName != null) {
