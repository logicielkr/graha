...
public class ValidationParam {
	...
	protected Buffer toXSL(Record param, int indent, boolean rdf) {
		...
		if(STR.trueValue(this.getMulti())) {
			...
			} else if(STR.valid(this.getDateFormat())) {
			...
			} else if(STR.valid(this.getNotNull())) {
			...
			} else if(STR.valid(this.getMaxLength())) {
			...
			} else if(STR.valid(this.getMinLength())) {
			...
			} else if(STR.valid(this.getMaxValue())) {
			...
			} else if(STR.valid(this.getMinValue())) {
			...
			} else if(STR.valid(this.getNumberFormat())) {
